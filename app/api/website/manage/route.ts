...
const Schema = z.object({
  ...
  action: z.enum(['createPage', 'changeTemplate', 'addSection', 'removeSection', 'reorderSection', 'editSection', 'editSourceText', 'swapSourceImage', 'editSourceCta', 'updateSeo', 'addAffiliate', 'attachCatalogAffiliate', 'schedule', 'cancelSchedule', 'unpublish']),
  actor: WebsiteActorSchema.omit({ at: true }).extend({ at: z.string().optional() }),
  pagePath: z.string().optional(), revisionId: z.string().optional(), templateId: z.string().optional(), section: z.unknown().optional(), sectionId: z.string().optional(), index: z.number().int().optional(), patch: z.record(z.unknown()).optional(), seo: z.unknown().optional(), offer: z.unknown().optional(), catalogProductId: z.string().optional(), matchReason: z.string().max(1000).optional(), scheduledFor: z.string().optional(), scheduleAction: z.enum(['publish', 'unpublish']).optional(), scheduleId: z.string().optional(), title: z.string().optional(), pageType: z.enum(['standard', 'article', 'destination', 'campaign']).optional(), match: z.string().max(10000).optional(), replacement: z.string().max(10000).optional(), sourceUrl: z.string().max(2000).optional(), replacementUrl: z.string().max(2000).optional(), alt: z.string().max(500).optional(), href: z.string().max(2000).optional(),
});
