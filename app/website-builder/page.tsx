...
import { WebsiteStructurePanel, WEBSITE_BLOCK_COPY } from '@/components/WebsiteStructurePanel';
...
type BuilderTab = 'build' | 'site' | 'content' | 'review';
...
export default function WebsiteBuilderPage() {
  ...
  async function generatePage(request = prompt) {
    ...
    try {
      const response = await fetch('/api/ai/design-brief', { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ prompt: cleanRequest, direction }) });
