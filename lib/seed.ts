...
const agents: Agent[] = ([
  ...
  // ── Marketing/Growth: social/content crew ───────────────────────────
  {
    ...
    status: 'active',
    tier: 'lead',
    description: 'Owns value-first content production: original research, humanized faceless video, owned-audience bridges, SEO resources, and approved distribution.',
    model: 'aggregate of workers',
  ...
  },
  {
    ...
    role: 'Original Creative Direction',
    status: 'active',
    tier: 'worker',
    description: 'Develops original visual concepts and real-asset direction for approved campaigns; no scraped footage or mass-produced variants.',
    model: 'adsmith api',
    tools: ['adsmith'],
    parentId: 'social-agent',
    instance: 'builtin',
  },
  {
    ...
    status: 'active',
    tier: 'worker',
    description: 'Turns approved research into humanized faceless videos with original commentary, licensed visuals, captions, and platform-ready cuts.',
  ...
  },
  {
    ...
    status: 'active',
    tier: 'worker',
    description: 'Prepares real-image direction, thumbnails, visual explainers, and accessible creative assets from the approved source packet.',
    model: 'renderly cli',
    tools: ['renderly'],
    parentId: 'social-agent',
    instance: 'builtin',
...
const skills: Omit<Skill, 'markdown'>[] = [
  ...
  { id: 'skill-hooks', name: 'Evidence-led hook writing', category: 'Content', description: 'Writes specific hooks that promise a useful answer without clickbait or unsupported claims.', ownerAgentId: 'social-agent', status: 'live', tools: ['postly', 'gbrain'], order: 3 },
  { id: 'skill-ugc', name: 'Humanized faceless production', category: 'Content', description: 'Directs original commentary, licensed visuals, authorized narration, and human review for faceless videos.', ownerAgentId: 'adsmith-creative', status: 'live', tools: ['adsmith', 'gbrain'], order: 4 },
  { id: 'skill-edit', name: 'Value-first video editing', category: 'Content', description: 'Cuts research-backed videos with readable captions, original visual structure, and accessibility checks.', ownerAgentId: 'reelkit-editor', status: 'live', tools: ['reelkit', 'whisper'], order: 5 },
  { id: 'skill-schedule', name: 'Owned-audience distribution', category: 'Content', description: 'Adapts approved work for discovery channels and routes attention to the owned email or community relationship.', ownerAgentId: 'postly-publisher', status: 'live', tools: ['postly', 'beehiiv'], order: 6 },
  ...
  { id: 'skill-seo-brief', name: 'SEO content brief', category: 'Content', description: 'Creates search-intent briefs, outlines, internal-link plans, and factual source requirements.', ownerAgentId: 'conductor', status: 'learning', tools: ['gbrain', 'wordpress'], order: 14 },
  { id: 'skill-blog-builder', name: 'Affiliate blog builder', category: 'Content', description: 'Drafts reviewable travel guides and product roundups with affiliate disclosures and source links.', ownerAgentId: 'renderly-creative', status: 'learning', tools: ['wordpress', 'viator'], order: 15 },
  { id: 'skill-brand-voice', name: 'Brand voice guardian', category: 'Brand', description: 'Checks every draft against the approved travel brand voice, audience, claims, and visual direction.', ownerAgentId: 'social-agent', status: 'learning', tools: ['gbrain'], order: 16 },
  { id: 'skill-wordpress-publish', name: 'WordPress page publishing', category: 'Website', description: 'Prepares WordPress page changes for review and records the exact proposed diff before publishing.', ownerAgentId: 'website-designer', status: 'planned', tools: ['wordpress', 'elementor'], order: 17 },
  { id: 'skill-image-content', name: 'Image campaign analysis', category: 'Creative', description: 'Extracts visual cues and likely locations from uploaded images, then proposes campaign concepts.', ownerAgentId: 'renderly-creative', status: 'learning', tools: ['gbrain'], order: 18 },
  { id: 'skill-calendar-campaign', name: 'Seasonal campaign calendar', category: 'Marketing', description: 'Turns holidays and travel seasons into dated content, review, and publishing milestones.', ownerAgentId: 'postly-publisher', status: 'planned', tools: ['gcal', 'postly'], order: 19 },
  { id: 'skill-social-analytics', name: 'Social performance analysis', category: 'Analytics', description: 'Reads connected social performance and recommends evidence-based content experiments.', ownerAgentId: 'social-agent', status: 'learning', tools: ['zernio', 'gbrain'], order: 20 },
  { id: 'skill-compliance-disclosure', name: 'Affiliate compliance review', category: 'Compliance', description: 'Checks disclosures, claims, platform rules, and source attribution before publication.', ownerAgentId: 'conductor', status: 'planned', tools: ['gbrain'], order: 21 },
  { id: 'skill-growth-retrospective', name: 'Campaign retrospective', category: 'Analytics', description: 'Compares approved campaign results with its hypothesis and proposes the next improvement cycle.', ownerAgentId: 'conductor', status: 'planned', tools: ['trakyo', 'zernio', 'gbrain'], order: 22 },
];
