...
export const affiliateStudioTeam = [
  ...
  { id: 'website-designer', name: 'Website Designer', role: 'Template-to-site builder', agentId: 'renderly-creative', responsibilities: ['inspect approved templates and build the complete page tree', 'apply approved brand tokens and rights-cleared assets', 'generate preview-first WordPress/Elementor drafts'] },
