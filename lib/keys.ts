...
export const KEY_SLOTS: KeySlot[] = [
  ...
  { envVar: 'GROQ_API_KEY', label: 'Groq free-tier key', group: 'AI Automation' },
  { envVar: 'CEREBRAS_API_KEY', label: 'Cerebras key', group: 'AI Automation' },
  { envVar: 'TOGETHER_API_KEY', label: 'Together key', group: 'AI Automation' },
  { envVar: 'MISTRAL_API_KEY', label: 'Mistral key', group: 'AI Automation' },
  { envVar: 'DEEPSEEK_API_KEY', label: 'DeepSeek key', group: 'AI Automation' },
  { envVar: 'FIREWORKS_API_KEY', label: 'Fireworks key', group: 'AI Automation' },
  { envVar: 'AI_API_KEY', label: 'Custom AI key', group: 'AI Automation' },
  { envVar: 'AI_BASE_URL', label: 'Custom OpenAI-compatible URL', group: 'AI Automation', hint: 'https://…/v1' },
  { envVar: 'OLLAMA_BASE_URL', label: 'Ollama URL', group: 'AI Automation', hint: 'http://localhost:11434' },
  { envVar: 'AMAZON_ASSOCIATE_TAG', label: 'Amazon Associate tag', group: 'Affiliate Networks' },
  { envVar: 'AMAZON_PA_API_KEY', label: 'Amazon Product API key', group: 'Affiliate Networks' },
  { envVar: 'IMPACT_ACCOUNT_ID', label: 'Impact account ID', group: 'Affiliate Networks' },
  { envVar: 'IMPACT_API_KEY', label: 'Impact API key', group: 'Affiliate Networks' },
  { envVar: 'CJ_API_KEY', label: 'CJ API key', group: 'Affiliate Networks' },
  { envVar: 'CJ_WEBSITE_ID', label: 'CJ website ID', group: 'Affiliate Networks' },
  { envVar: 'SHAREASALE_API_TOKEN', label: 'ShareASale token', group: 'Affiliate Networks' },
  { envVar: 'CLICKBANK_API_KEY', label: 'ClickBank API key', group: 'Affiliate Networks' },
  { envVar: 'AWIN_API_TOKEN', label: 'Awin API token', group: 'Affiliate Networks' },
  { envVar: 'AWIN_PUBLISHER_ID', label: 'Awin publisher ID', group: 'Affiliate Networks' },
  { envVar: 'RAKUTEN_API_KEY', label: 'Rakuten API key', group: 'Affiliate Networks' },
  { envVar: 'ALIEXPRESS_API_KEY', label: 'AliExpress API key', group: 'Affiliate Networks' },
  { envVar: 'VIATOR_API_KEY', label: 'Viator API key', group: 'Affiliate Networks' },
  { envVar: 'VIATOR_PARTNER_ID', label: 'Viator partner ID', group: 'Affiliate Networks' },
];
